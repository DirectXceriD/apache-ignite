...
public class FrequencyEncoderPreprocessorTest {
    ...
    public void testApply() {
        ...
        FrequencyEncoderPreprocessor<Integer, String[]> preprocessor = new FrequencyEncoderPreprocessor<Integer, String[]>(
            new HashMap[] {
                new HashMap() {
                    {
                        put("1", 0.33);
        ...
        for (int i = 0; i < data.length; i++)
            assertArrayEquals(postProcessedData[i], preprocessor.apply(i, data[i]).asArray(), 0.1);
    }
}
