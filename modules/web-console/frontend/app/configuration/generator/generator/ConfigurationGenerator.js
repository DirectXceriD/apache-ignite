        ...
        if (available('2.5.0')) {
            ...
            switch (kind) {
                case 'RestartProcess':
                    ...
                    break;
                case 'StopNodeOnHalt':
                    bean = new Bean('org.apache.ignite.failure.StopNodeOrHaltFailureHandler', 'failureHandler', handler);
            ...
            if (bean) {
                if (['RestartProcess', 'StopNodeOnHalt', 'StopNode'].indexOf(kind) >= 0) {
                    bean.collectionProperty('failureHandler', 'failureHandler', handler.ignoredFailureTypes,
